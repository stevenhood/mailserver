...
public interface IDatabase {
	 ...
	 * 
	 * @param pass
	 *            the corresponding password of the last issued USER command
	 *            (case sensitive).
	 ...
	 * 
	 * @param messageNumber
	 *            number of the message to mark as deleted.
	 ...
	 * 
	 * @param messageNumber
	 *            number of the message in the mailbox. If negative, return
	 ...
	 * @param lineCount
	 *            number of lines of message to return, starting from the
